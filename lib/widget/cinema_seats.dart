...
import 'package:vendor_app/constance.dart';
...
class CienmaSeat extends StatefulWidget {
  ...
  CienmaSeat({this.isSelected, this.isReserved ,  
  ...
  Widget build(BuildContext context) {
    return InkWell(
        ...
        child: Container(
            ...
            decoration: BoxDecoration(color: widget.isReserved? Colors.white : 
            widget.isSelected ? Colors.pink : null, 
